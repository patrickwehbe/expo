...
test('returns routes in declaration order regardless of the routes (back-stack) order', () => {
  const state = makeState(['a', 'b', 'c'], ['b', 'c', 'a']);
